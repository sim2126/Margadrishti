...
the production serving store (see parkiq.db.serving). The CI/offline tier never touches
network or Docker.
...
class Storage:
    ...
    # PostGIS publishing lives ONLY in parkiq.db.serving.publish_all (TRUNCATE+INSERT into

...
SYSTEM = (
    "You are Margadrishti's enforcement copilot for the Bengaluru Traffic Police. Answer ONLY "
...
def ask(question: str, *, lang: str = "en", svc: MargadrishtiService | None = None) -> CopilotAnswer:
